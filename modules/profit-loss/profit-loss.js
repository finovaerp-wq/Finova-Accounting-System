        ...
        try {
            ...
            */
            ...
            this.showError(
                ...
                error?.message
                ||
                "Failed to initialize Profit & Loss."
    ...
    */
    ...
    cacheDom() {
        ...
        */
        ...
        this.btnDownload =
            document.getElementById(
                "btn-download-excel-profit-loss"
            );


        this.btnPreview =
            document.getElementById(
                "btn-preview-html-profit-loss"
            );


        this.btnRefresh =
            document.getElementById(
                "btn-refresh-profit-loss"
            );
        ...
        */
        ...
        this.btnFirst =
            document.getElementById(
                "profit-loss-page-first"
            );


        this.btnPrev =
            document.getElementById(
                "profit-loss-page-prev"
            );


        this.btnNext =
            document.getElementById(
                "profit-loss-page-next"
            );


        this.btnLast =
            document.getElementById(
                "profit-loss-page-last"
            );
        ...
        this.totalPagesLabel =
            document.getElementById(
                "profit-loss-total-pages"
            );


        this.recordInfo =
            document.getElementById(
                "profit-loss-record-info"
            );
                        ...
                        ${
                            ...
                            row.account_name
                                ...
                                ? `
                                    ...
                                    <span class="pl-account-separator">
                                        ::
                                    </span>
        ...
        try {
            ...
            */
            ...
            if (
                ...
                this.showError(
                    "No Profit & Loss data available to preview."
                );
